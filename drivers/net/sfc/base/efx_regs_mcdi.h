 ...
 *
 * Copyright 2008-2019 Solarflare Communications Inc.
 * All rights reserved.
 */
...
/* Any non-zero bits other than the ones named below will cause the NIC to
 * return EOPNOTSUPP. In the future more flags may be added.
 */
