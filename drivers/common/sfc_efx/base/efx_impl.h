...
typedef struct efx_nic_dma_regioned_s {
	unsigned int		endr_num;
	efx_nic_dma_region_t	*endr_regions;
} efx_nic_dma_regioned_t;

typedef struct efx_nic_dma_s {
	union {
		/* No configuration in the case flat mapping type */
		efx_nic_dma_regioned_t	endu_regioned;
	} end_u;
} efx_nic_dma_t;
